...
SYNONYMS: dict[str, set[str]] = {
    # 🎯 «База» = Sanarip Clinic — главный контекст
    "база": {"санарип", "санприп", "sanarip", "мис", "система", "программа", "тундук", "түндүк"},
    "базы": {"санарип", "санприп", "sanarip", "мис", "система", "программа"},
    "базу": {"санарип", "санприп", "sanarip", "мис", "система", "программа"},
    "базе": {"санарип", "санприп", "sanarip", "мис", "система", "программа"},
    "санарип": {"база", "санприп", "sanarip", "мис", "система", "программа", "тундук", "түндүк"},
    "санприп": {"база", "санарип", "sanarip", "мис", "система"},
    "sanarip": {"база", "санарип", "санприп", "мис", "система"},
    "мис": {"база", "санарип", "санприп", "sanarip", "система"},
    "тундук": {"түндүк", "база", "санарип", "мис", "приложение"},
    "түндүк": {"тундук", "база", "санарип", "мис", "приложение"},
    "система": {"база", "санарип", "санприп", "sanarip", "мис", "программа"},
    "программа": {"база", "санарип", "система", "мис"},
    "сайт": {"база", "санарип", "мис", "система", "портал"},
    "портал": {"сайт", "база", "система"},
    ...
    "не": {"жок", "иштебей"},
    "жок": {"не", "иштебей"},
    "иштебей": {"не работает", "неработает", "сломан", "отключен"},

    # Ошибки
    "ошибка": {"баг", "глюк", "error", "проблема", "ката"},
    "баг": {"ошибка", "глюк", "проблема"},
    "глюк": {"ошибка", "баг", "проблема"},
    "сбой": {"ошибка", "баг", "проблема"},

    # Модули системы
    "карта": {"медкарта", "пациент", "амбулаторная", "стационарная"},
    "медкарта": {"карта", "пациент", "амбулаторная", "стационарная"},
    "пациент": {"карта", "медкарта", "бейтап"},
    "бейтап": {"пациент", "больной"},
    "амбулаторная": {"поликлиника", "карта", "медкарта"},
    "стационарная": {"больница", "стационар", "карта"},
    "больничный": {"лвн", "лист", "нетрудоспособности"},
    "лвн": {"больничный", "лист", "нетрудоспособности"},
    "анализы": {"лаборатория", "ilab", "исследование", "результаты"},
    "лаборатория": {"анализы", "ilab", "исследование"},
    "ilab": {"анализы", "лаборатория", "исследование"},

    # Запись / приём
    "запись": {"записаться", "прием", "приём", "талон"},
    "талон": {"запись", "прием", "приём"},
    "прием": {"приём", "запись", "талон"},

    # ЦСМ / ГСВ
    "цсм": {"гсв", "пмсп", "центр", "подразделение"},
    "гсв": {"цсм", "пмсп", "подразделение"},

    # Вход / пароль
    "пароль": {"password", "логин", "login", "вход"},
    "логин": {"пароль", "вход", "login"},
    "вход": {"пароль", "логин", "войти", "зайти", "авторизация"},

    # Печать / выгрузка
    "печать": {"принтер", "распечатать", "печатает"},
    "принтер": {"печать", "распечатать"},
    "отчет": {"отчёт", "report", "сводка", "выгрузка"},
    "отчёт": {"отчет", "report", "сводка", "выгрузка"},
    "выгрузка": {"экспорт", "скачать", "export"},
    "экспорт": {"выгрузка", "report", "скачать"},
    "выписка": {"выписк", "справка", "скачать"},
}
...
class SupportRepository:
    ...
    # ---------- KbVote (не используется, оставлено на будущее) ----------
